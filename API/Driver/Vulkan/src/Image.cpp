    ...
    }
    {
        ...
        transferCommandBuffer->begin(cmdBufferBeginInfo);
        {
            Command::TransitionImageLayout(
                transferCommandBuffer, { a_DstImage, imageRange, ImageLayout::Undefined, ImageLayout::TransferDstOptimal });
        }
        ...
        {
            Command::TransitionImageLayout(
                transferCommandBuffer, { a_DstImage, imageRange, ImageLayout::TransferDstOptimal, a_DstImageLayout });
        }
