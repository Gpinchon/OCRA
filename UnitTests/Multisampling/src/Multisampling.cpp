...
constexpr auto Samples = SampleCount::Count64;
constexpr auto Resolve = ResolveMode::Average;
...
struct MultisamplingTestApp : TestApp
{
    MultisamplingTestApp()
        : TestApp("Test_Multisampling")
    ...
    void RecordDrawCommandBuffer()
    {
        ...
        renderingAttachment.imageViewResolve   = resolveImageView;
